...
class VirtualMechanismInterface
{
	public:
	  ...
	  phase_prev_(0.0),phase_dot_(0.0),phase_dot_learnt_(0.0),K_(K),B_(B),clamp_(1.0),adapt_gains_(false),Kf_(Kf),fade_(0.0),active_(false),move_forward_(true)
	  {
